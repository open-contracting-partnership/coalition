...
<div class="bg-n-10">
    <div class="container py-10 md:pt-16 md:pb-20">
        <h2 class="font-bold">Other evidences</h2>
        <?php
        $args = array(
            'post_type'             => 'evidence',
            'posts_per_page'        => '3',
        ...
        if ($the_query->have_posts()) { ?>
            <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                ...
                ?>
                    <div id="evidence_<?php echo $id; ?>" class="p-5 border border-n-30 rounded-3xl bg-n-0 news-card-hover">
                        <div class="pt-[63.8%] relative">
                            <a href="<?php echo get_the_permalink(); ?>">
                                <img src="<?php echo $feature_img; ?>" alt="evidence-image" class=" absolute top-0 h-full w-full object-cover rounded-2xl ">
                            </a>
                        </div>
                        <div class="pt-6">
